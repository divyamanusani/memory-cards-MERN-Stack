import { CREATE,DELETE,FETCH_ALL,UPDATE,LIKEPOST } from "../constants/actionTypes.js";
...
const reducer = (posts = [], action) => {
    switch (action.type) {
        ...
        case LIKEPOST: return posts.map((post) => post._id === action.payload._id ? action.payload : post);
